    ...
    return (
        <Box>
            <IconButton
                ...
                ref={menuRef}
            >
                <Avatar sx={{ width: 42, height: 42, backgroundColor: '#000', color:'yellow'}}>IG</Avatar>
            </IconButton>
...
const DashboardLayout = () => {
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <AppBar sx={{position:"absolute", backgroundColor: 'yellow'}}>
                <Toolbar
                    sx={{
                        pr: '24px',
                    }}
                ...
                >
                    <Button sx={{ color: '#000' }} onClick={() => setOpen(true)}>
                        <MenuIcon />
                    </Button>
